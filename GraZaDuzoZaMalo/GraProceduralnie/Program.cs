...
namespace GraMonolitycznie
{
    class Program
    {
        ...
        /// <exception cref="OperationCanceledException">Gdy wprowadzono znak 'x' lub 'X'</exception>
        ...
        {
            int min = WczytajLiczbe("Podaj zakres minimalny: ");
            int max = WczytajLiczbe("Podaj zakres maksymalny: ");
